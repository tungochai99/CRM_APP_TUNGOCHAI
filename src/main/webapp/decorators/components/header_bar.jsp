                ...
                <ul class="nav navbar-nav d-none d-sm-flex border-left navbar-border navbar-height align-items-center">
                    <li class="nav-item dropdown">
                        ...
                        <div id="account_menu" class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item active" href="<c:url value="<%=PathUtils.HOME %>" />">
                                Dashboard
                            </a>
                            <a class="dropdown-item" href="<c:url value="<%=PathUtils.USER_PROFILE %>" />"> 
                                My profile
                            </a>
                            <a class="dropdown-item" href="<c:url value="<%=PathUtils.USER_EDIT %>" />">
                                Edit account
                            </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="<c:url value="<%=PathUtils.LOGOUT %>" />">Logout</a>
                        </div>
                    </li>
                </ul>
            </div>
